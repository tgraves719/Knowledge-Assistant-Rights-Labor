...
OUT_PATH = DATA_DIR / "test_set" / "cross_contamination_results.json"
...
def main():
    ...
    if len(contract_ids) < 2:
        ...
        report = {
            "schema_version": "cross_contamination_eval_v1",
            "timestamp_utc": datetime.now(timezone.utc).isoformat(),
            "contracts_tested": contract_ids,
            "pairs_tested": 0,
            "queries_per_pair": len(TEST_QUERIES),
            "failures_count": 0,
            "failures": [],
            "skipped": True,
            "pass": not args.require_multi_contract,
            "require_multi_contract": bool(args.require_multi_contract),
